...
func (p *OktaProvider) GetProviderSource() addrs.Provider {
	return addrs.NewProvider(addrs.DefaultRegistryHost, "okta", "okta")
}
...
func (p *OktaProvider) GetSupportedService() map[string]terraformutils.ServiceGenerator {
	return map[string]terraformutils.ServiceGenerator{
		...
		"okta_app_policy_signon":         &AppSignOnPolicyGenerator{},
		"okta_app_policy_rule_signon":    &AppSignOnPolicyRuleGenerator{},
